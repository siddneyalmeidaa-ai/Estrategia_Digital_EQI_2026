...
<style>
    ...
    /* Estilização para garantir que a tabela e legenda caibam no PDF */
...
# DADOS DAS FASES (DIDÁTICA SOLICITADA)
dados_fases = {
...
with tab3:
    # INÍCIO DO BLOCO BRANCO UNIFICADO
    st.markdown(f"""
    ...
    # TABELA DENTRO DA ÁREA BRANCA (Simulada pelo fluxo do Streamlit)
    st.table(df_visual)

    # FINAL DO BLOCO BRANCO (Legenda e Botão)
    st.markdown("""
    <div style="background-color: white; padding: 0 25px 25px 25px; border-radius: 0 0 8px 8px; color: #1a1a1a;">
    ...
    # BOTÃO DE DOWNLOAD REPOSICIONADO
